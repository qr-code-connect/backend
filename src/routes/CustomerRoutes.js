...
import { createCustomer, getAllCustomers, getCusotmerById, updateCustomer, deleteCustomer } from '../controllers/CustomerController.js';
...
router.get('/get_customer/:id', getCusotmerById);
